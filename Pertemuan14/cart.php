            ...
            <form method = "POST">
                <table class = "center" id = "t01">
                    ...
                    for ($i = 0; $i<count($cart); $i++){
                        ...
                        ?>
                        <tr>
                            <td><a href="cart.php?index=<?php echo $index; ?>" onclick ="return confirm('Yakin Ingin Menghapus?')"></a></td>
                            <td> <?php echo $cart [$i]->id; ?></td>
                            <td> <?php echo $cart [$i]->nama; ?></td>
                            <td> Rp. <?php echo $cart [$i]->harga; ?></td>
                            <td><input type="number" min = "1" value = " <?php echo $cart [$i]->jumlah; ?>" name="jumlah[]"></td>
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="update"></td>
                    </tr>
                </table>
            </form>
            <br>
            <a href="barang.php">Lanjutkan Belanja</a> |
